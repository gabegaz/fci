...
app = DjangoDash('LoanOutstandingBanks', add_bootstrap_links=True, 
...
df_level   =  pd.read_excel(data+'loan_outstanding_banks.xlsx',
                sheet_name='loan_outstanding_banks_level',
                skiprows=1, nrows=40, usecols='A:W')

df_share   =  pd.read_excel(data+'loan_outstanding_banks.xlsx',
                sheet_name='loan_outstanding_banks_share',
                skiprows=1, nrows=40, usecols='A:W')


df_growth   =  pd.read_excel(data+'loan_outstanding_banks.xlsx',
                sheet_name='loan_outstanding_banks_growth',
                skiprows=1, nrows=40, usecols='A:W')


df_contrib  =  pd.read_excel(data+'loan_outstanding_banks.xlsx',
                sheet_name='loan_outstanding_banks_contrib',
                skiprows=1, nrows=40, usecols='A:W')
...
def level(lender):
    ...
    fig = px.line(dff_level, x= 'year',
                  y = 'level',
                  color='Lender',
                  title = "LO #1: Loan Outstanding (Millions of Birr)-Lender",
                  labels={
                     "year": "Time in year",
...
def growth(lender):
    ...
    fig = px.line(dff_share, x= 'year',
                  y = 'share',
                  color='Lender',
                  title = "LO #2: Share of Loan Outstanding (Percent)-Lender",
                  labels={
                     "year": "Time in year",
                     "share": "Share (percent)",
                     }
...
def share(lender):
    ...
    fig = px.line(dff_growth, x= 'year',
                  y = 'growth',
                  color='Lender',
                  title = "LO #3: Growth Rate of Loan Outstanding (Percent)-Lender",
                  labels={
                     "year": "Time in year",
...
def contribution(lender):
    ...
    fig = px.line(dff_contrib, x= 'year',
                  y = 'contrib',
                  color='Lender',
                  title = "LO #4: Contribution of Loan Outstanding (Percent)-Lender",
                  labels={
                     "year": "Time in year",

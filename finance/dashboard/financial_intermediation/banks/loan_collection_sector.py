...
app = DjangoDash('LoanCollectionSector', add_bootstrap_links=True, 
...
df_level   =  pd.read_excel(data+'loan_collection_sector.xlsx',
                sheet_name='loan_collection_sector_level',
                skiprows=1, nrows=39, usecols='A:N')

df_share   =  pd.read_excel(data+'loan_collection_sector.xlsx',
                sheet_name='loan_collection_sector_share',
                skiprows=1, nrows=39, usecols='A:N')


df_growth   =  pd.read_excel(data+'loan_collection_sector.xlsx',
                sheet_name='loan_collection_sector_growth',
                skiprows=1, nrows=39, usecols='A:N')


df_contrib  =  pd.read_excel(data+'loan_collection_sector.xlsx',
                sheet_name='loan_collection_sector_contrib',
                skiprows=1, nrows=39, usecols='A:N')
...
def level(sector):
    ...
    fig = px.line(dff_level, x= 'year',
                  y = 'level',
                  color='Sector',
                  title = "LC #9: Collection of Loans (Millions of Birr)-Sector",
                  labels={
                     "year": "Time in year",
...
def growth(sector):
    ...
    fig = px.line(dff_share, x= 'year',
                  y = 'share',
                  color='Sector',
                  title = "LC #10: Share of Collection of Loans (Percent)-Sector",
                  labels={
                     "year": "Time in year",
                     "share": "Share (percent)",
                     }
...
def share(sector):
    ...
    fig = px.line(dff_growth, x= 'year',
                  y = 'growth',
                  color='Sector',
                  title = "LC #11: Growth Rate of Collection of Loans (Percent)-Sector",
                  labels={
                     "year": "Time in year",
...
def contribution(sector):
    ...
    fig = px.line(dff_contrib, x= 'year',
                  y = 'contrib',
                  color='Sector',
                  title = "LC #12: Contribution to Growth of Collection of Loans (Percent)-Sector",
                  labels={
                     "year": "Time in year",

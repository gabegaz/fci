...
app = DjangoDash('LoanOutstandingClient', add_bootstrap_links=True, 
...
df_level   =  pd.read_excel(data+'loan_outstanding_client.xlsx',
                sheet_name='loan_outstanding_client_level',
                skiprows=1, nrows=40, usecols='A:E')

df_share   =  pd.read_excel(data+'loan_outstanding_client.xlsx',
                sheet_name='loan_outstanding_client_share',
                skiprows=1, nrows=40, usecols='A:E')


df_growth   =  pd.read_excel(data+'loan_outstanding_client.xlsx',
                sheet_name='loan_outstanding_client_growth',
                skiprows=1, nrows=40, usecols='A:E')


df_contrib  =  pd.read_excel(data+'loan_outstanding_client.xlsx',
                sheet_name='loan_outstanding_client_contrib',
                skiprows=1, nrows=40, usecols='A:E')
...
def level(client):
    ...
    fig = px.line(dff_level, x= 'year',
                  y = 'level',
                  color='Client',
                  title = "LO #5: Loan Outstanding (Millions of Birr)-Client",
                  labels={
                     "year": "Time in year",
...
def growth(client):
    ...
    fig = px.line(dff_share, x= 'year',
                  y = 'share',
                  color='Client',
                  title = "LO #6: Share of Loan Outstanding (Percent)-Client",
                  labels={
                     "year": "Time in year",
                     "share": "Share (percent)",
                     }
...
def share(client):
    ...
    fig = px.line(dff_growth, x= 'year',
                  y = 'growth',
                  color='Client',
                  title = "LO #7: Growth Rate of Loan Outstanding (Percent)-Client",
                  labels={
                     "year": "Time in year",
...
def contribution(client):
    ...
    fig = px.line(dff_contrib, x= 'year',
                  y = 'contrib',
                  color='Client',
                  title = "LO #8: Contribution to Growth of Loan Outstanding (Percent)-Client",
                  labels={
                     "year": "Time in year",
